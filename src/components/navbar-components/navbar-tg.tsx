...
const NavbarTG = () => {
  ...
  return (
    <header className={`flex w-full items-center bg-white dark:bg-slate-900`}>
      <div className="container">
        <div className="relative mx-6 flex items-center justify-between">
          <div className="w-60 max-w-full px-4">
            <Link href="/#" className="block w-full py-5">
             <p className="font-black text-2xl">T3 EBOOK</p>
            </Link>
          </div>
...
const ListItem = ({ children, NavLink }: { children: string, NavLink: string }): React.JSX.Element => {
  return (
    <>
      <li>
        <Link
